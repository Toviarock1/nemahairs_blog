          ...
          <Row>
            ...
            <Col className="d-flex mt-3" lg={6} xs={12}>
              ...
              <div className={classes.IconWrapper}>
                <a href={props.footerTwitterUrl}>
                  <FaTwitterSquare className={classes.Icon} />
                </a>
                <a href={props.footerFacebookUrl} className="mx-2">
                  <FaFacebookSquare className={classes.Icon} />
                </a>
                <a href={props.footerInstagramUrl}>
                  <FaInstagramSquare className={classes.Icon} />
                </a>
                <a href={props.footerLinkedinUrl} className="mx-2">
                  <FaLinkedin className={classes.Icon} />
                </a>
                <a href={props.footerPinterestUrl}>
