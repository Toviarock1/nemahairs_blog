...
//images
import image from "./../../assets/images/pexels-ricaldo-donaldson-1686274.jpg";
//css
          ...
          return (
            <Slide.Item key={slideItem.id}>
              ...
              <Slide.Caption>
                ...
                <Button
                  style={{
                    backgroundColor: slideItem.btnBgColor,
                    color: slideItem.btnColor,
                  }}
                >
                  {slideItem.btnText}
                </Button>
